...
Add this to your Gemfile and run the <tt>bundle</tt> command.
  ...
  gem "rails_redmine_issues", github: "constella/rails_redmine_issues", branch: 'cancan'
...
This branch allows you to use cancan:

  if can? :read, :issues_write
